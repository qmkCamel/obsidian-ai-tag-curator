# tag-cleanup-review-plan Specification

## Purpose
Define the cleanup review plan generated from tag health reports and the cached tag index, including affected-file previews and Markdown export while preserving read-only behavior for plan generation, review, and copy operations.
